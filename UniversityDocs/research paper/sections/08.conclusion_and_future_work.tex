...
\begin{itemize}
  ...
  \item Memory vs. latency trade-off: INT8 quantization compared to FLOAT32 cuts peak RAM by about $\approx33\%$ and model file size by $\approx60\%$, but on the tested ESP32-class hardware it increased latency because efficient INT8 vector instructions are lacking.
